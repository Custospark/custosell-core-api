...
return [
    ...
    'Bundibugyo', 'Bunyangabu', 'Bushenyi', 'Busia', 'Butaleja', 'Butambala',
    'Butebo', 'Buvuma', 'Buyende', 'Dokolo', 'Gomba', 'Gulu', 'Hoima', 'Ibanda',
    ...
    'Kole', 'Kotido', 'Kumi', 'Kween', 'Kyankwanzi', 'Kyegegwa', 'Kyenjojo',
    ...
    'Rakai', 'Rubanda', 'Rubirizi', 'Rukungiri', 'Rwampara', 'Sembabule', 'Serere',
    'Sheema', 'Sironko', 'Soroti', 'Ssembabule', 'Terego', 'Tororo', 'Wakiso',
    'Yumbe', 'Zombo',
    // Kenya
    ...
    'Damascus', 'Baghdad', 'Basra', 'Tehran', 'Mashhad', 'Tel Aviv', 'Jerusalem', 'Riyadh City',
    // ---- Europe ----
