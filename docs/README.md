...
| [2026-08-10-subscription-state-machine-audit.md](./adr/2026-08-10-subscription-state-machine-audit.md) | Subscription state machine audit - full transition map from birth, date triggers, loopholes (cron suspension gap, offline stale-active risk) |
| [2026-08-10-plan-identity-follows-payment.md](./adr/2026-08-10-plan-identity-follows-payment.md) | Plan identity follows payment - reactivation/resubscription moves plan_id to the plan actually paid for; no plan/subscription effect without confirmed payment (raw CRUD + un-gated reactivate removed, read-all platform-only) |
| [2026-08-11-chart-of-accounts-auto-seed.md](./adr/2026-08-11-chart-of-accounts-auto-seed.md) | Chart of accounts auto-seeded on personal + business registration (transactional, idempotent); `accounting:seed-chart-of-accounts` legacy backfill |
| [2026-08-21-decimal-quantities-unit-pricing.md](./adr/2026-08-21-decimal-quantities-unit-pricing.md) | Decimal quantities end-to-end + unit-based per-unit pricing (weight/volume fractional, custom units integer-safe); legacy `pricing_unit` backfill |
| [2026-08-11-legacy-businesses-enterprise-plan.md](./adr/2026-08-11-legacy-businesses-enterprise-plan.md) | Legacy businesses upgraded from Essential to Enterprise plan (idempotent data migration; original backfill untouched) |
