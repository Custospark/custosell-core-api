...
class RatioRecommendationText
{
    public function message(string $key, float $value, string $status): string
    {
        $messages = [
            'current_ratio' => [
                'healthy' => sprintf(
    ...
    public function action(string $key, string $status): string
    {
        $actions = [
            'current_ratio' => [
