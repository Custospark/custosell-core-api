...
trait StorefrontCatalogConcern
{
    ...
    public function publicProductPayload(Product $product, ?int $viewerUserId = null): array
    {
        ...
        return [
            ...
            'supports_decimal_quantity' => \App\Support\PricingUnits::supportsDecimalQuantity((string) ($product->pricing_unit ?? $product->unit ?? 'piece')),
            'pricing_unit_label' => \App\Support\PricingUnits::label((string) ($product->pricing_unit ?? $product->unit ?? 'piece')),
