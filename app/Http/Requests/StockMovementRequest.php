...
class StockMovementRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'stock_before' => ['required', 'numeric', 'min:0'],
            'stock_after' => ['required', 'numeric', 'min:0'],
