...
class PlanRequest extends BaseFormRequest
{
    ...
    public function messages(): array
    {
        return array_merge(parent::messages(), [
            ...
            'price_monthly_usd.required' => 'Please enter the monthly price in USD.',
            'price_monthly_usd.numeric' => 'The monthly price must be a number.',
            'price_monthly_usd.min' => 'The monthly price must be 0 or more.',
            'price_yearly_usd.numeric' => 'The yearly price must be a number.',
            'price_yearly_usd.min' => 'The yearly price must be 0 or more.',
