...
class ReferralResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'discount_type' => $this->referralCode?->discount_type,
            'discount_value' => $this->referralCode?->discount_value,
            'discount_duration_months' => $this->referralCode?->discount_duration_months,
